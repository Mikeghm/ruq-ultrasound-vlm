# CUDA_VISIBLE_DEVICES=0 python Bench/eval/eval_diseases_vqa.py
import os
import csv
import random
import numpy as np
...
def parse_args(args=None):
    ...
    parser.add_argument('--vqa_data_test_path', type=str, default="/workspace/VQA_Dataset/Ultrasound_Disease_Classification_VQA.csv")
    parser.add_argument('--close_ended', type=bool, default=True)
    parser.add_argument('--output_dir', type=str, default="/workspace/Eval_Diseases_VQA/")
    ...
    if args.close_ended:
        ...
        with open(output_path, mode='w') as outfile:
            ...
            for sample in tqdm(test_dataloader):
                ...
                with torch.inference_mode():
                    generation = model.generate(images=image, 
                                                inputs=input_ids,
                ...
                question_str = question[0].replace("<im_patch>", "")

                writer.writerow([question_type, question_str, answer[0], answer_choice[0], generated_texts[0], correct])
    else:
        ...
        with open(output_path, mode='w') as outfile:
            ...
            for sample in tqdm(test_dataloader):
                ...
                writer.writerow(
                    [question_type, question_str, answer[0], generated_texts[0], result["bleu"], result["rouge1"], result["meteor"], result["bert_f1"]])
