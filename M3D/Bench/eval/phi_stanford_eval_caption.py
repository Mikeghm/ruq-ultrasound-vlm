...
def parse_args(args=None):
    ...
    # data
    parser.add_argument('--data_root', type=str, default="/workspace/Ext_Val_Dataset/Standford_M3D_Ext_Val")
    parser.add_argument('--cap_data_path', type=str, default="/workspace/Ext_Val_Dataset/Standford_M3D_Ext_Val/ultrasound_dataset.json")
    parser.add_argument('--output_dir', type=str, default="/workspace/Ext_Val_Dataset/stanford_eval_caption_Phi3_4B/")
