...
def parse_args(args=None):
    ...
    parser.add_argument('--vqa_data_test_path', type=str, default="/workspace/VQA_Dataset/Ultrasound_VQA_Test.csv")
    parser.add_argument('--close_ended', type=bool, default=False)
    parser.add_argument('--output_dir', type=str, default="/workspace/Eval_VQA/")
