...
@dataclass
class DataArguments:
    data_root: str = field(default="/workspace/Ultrasound_Processed/", metadata={"help": "Root directory for all data."})

    # caption data
    cap_data_path: str = field(default="/workspace/Ultrasound_Processed/ultrasound_dataset.json", metadata={"help": "Path to caption data."})

    # VQA data
    vqa_data_train_path: str = field(default="/workspace/VQA_ICD_New/US_Disease_ICD_VQA_Train.csv", metadata={"help": "Path to training VQA data."})
    vqa_data_val_path: str = field(default="/workspace/VQA_ICD_New/US_Disease_ICD_VQA_Test.csv", metadata={"help": "Path to validation VQA data."})
    vqa_data_test_path: str = field(default="/workspace/VQA_ICD_New/US_Disease_ICD_VQA_Test.csv", metadata={"help": "Path to testing VQA data."})

    vqa_yn_data_train_path: str = field(default="/workspaces/M3D_Test/Oringinal_Dataset/M3D-VQA/M3D_VQA_yn_train.csv", metadata={"help": "Path to training VQA Yes or No data."})
