...
class ModelArguments:
    ...
    model_name_or_path: Optional[str] = field(default="/workspace/M3D-Original/LaMed/pretrained_model/Llama-3.1-8B-Instruct", metadata={"help": "Path to the LLM or MLLM. microsoft/Phi-3-mini-4k-instruct, llama-2-7b-chat"})
    model_type: Optional[str] = field(default='llama3.1-8b', metadata={"help": "llama2, phi3"})

    model_with_lora: Optional[str] = field(default="/workspace/M3D-Original/LaMed/output/LaMed-Llama3.1-8B-finetune-0000/model_with_lora.bin")
    ...
    pretrain_mm_mlp_adapter: Optional[str] = field(default='/workspace/M3D-Original/LaMed/output/LaMed-Llama3.1-8B-pretrain-0000/mm_projector.bin', metadata={"help": "Path to pretrained mm_projector and embed_tokens."})
    ...
    pretrain_vision_model: str = field(default='/workspace/M3D-Original/LaMed/pretrained_model/M3D-CLIP/pretrained_ViT.bin', metadata={"help": "Path to pretrained model for ViT."})
...
class TrainingArguments(transformers.TrainingArguments):
    ...
    output_dir: str = "./LaMed/output/LaMed-Llama3.1-8B-combined/hf/"
